...
|---------------------|-----------|
| Census Characteristics | Income, race, pct renters,median rent (monthly), unit characteristics |
| Temporal Characteristics | Year, season, policy indicators |
| Spatial Characteristics | Neighborhood effects, spatial lag |
| Control Variables | Population, housing density |


As there is barely census level monthly data available, and the temporal range for ACS census is 5 years. We decide a number of  
